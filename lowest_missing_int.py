...
"""
Create a function which, given an array A of N integers, returns the smallest positive
...
def solution(A):
    ...
    present = [False] * (N + 1)
    # creates an array of 'False' boolean values to use as switches for every number, +1 accoms the 0 array item
